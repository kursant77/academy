        ...
        <div className="relative py-8 sm:py-12 md:py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
            ...
            <Card className="overflow-hidden border-2 border-border/50 bg-card/80 backdrop-blur-md hover:border-primary/50 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10 animate-fade-in-up shadow-lg">
              <div className="h-64 sm:h-80 md:h-96 lg:h-[500px] bg-gradient-to-br from-primary/20 via-accent/10 to-primary/5 flex items-center justify-center relative group">
                <div className="absolute inset-0 bg-gradient-to-br from-primary/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                <div className="text-center space-y-3 relative z-10 px-4">
                  <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-primary/20 group-hover:bg-primary/30 transition-colors duration-300 mb-2 sm:mb-4">
                    <MapPin className="h-8 w-8 sm:w-10 sm:h-10 text-primary" />
                  </div>
