...
export class ErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    // Error logging service ga yuborish (masalan: Sentry, LogRocket)
    ...
    // Production da error tracking service ga yuborish
    if (import.meta.env.PROD) {
      // Masalan: Sentry.captureException(error, { contexts: { react: errorInfo } });
    }
  }
