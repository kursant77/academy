...
export function TeacherCard({
  ...
  return (
    <Card className="group relative overflow-hidden flex flex-col h-full border-2 border-border/50 bg-gradient-to-br from-card via-card to-card/95 backdrop-blur-sm transition-all duration-500 hover:border-primary/50 hover:shadow-2xl hover:scale-[1.02]">
      ...
      <CardContent className="relative z-10 pt-8 pb-4 space-y-5 flex-1">
        <div className="flex flex-col items-center text-center gap-4">
          ...
          <div className="space-y-2">
            <h3 className="text-xl md:text-2xl font-bold bg-gradient-to-r from-foreground via-primary to-foreground bg-clip-text text-transparent bg-[length:200%_auto] group-hover:animate-gradient transition-all duration-500" data-testid="text-teacher-name">
              {name}
            </h3>
            <p className="text-sm text-muted-foreground font-medium px-2">{specialty}</p>
          </div>
          
          {/* Experience badge with enhanced styling */}
          <Badge 
            variant="secondary" 
            className="px-4 py-1.5 text-xs font-semibold bg-gradient-to-r from-secondary/50 to-secondary/30 border border-border/50 group-hover:from-primary/20 group-hover:to-secondary/20 group-hover:border-primary/30 transition-all duration-300 group-hover:scale-110 shadow-sm" 
            data-testid="badge-experience"
          >
            <Star className="h-3 w-3 mr-1.5 fill-current text-primary" />
            {experience} {t("teachers.experience")}
          </Badge>
        </div>
        
        {/* Bio with improved styling */}
        <p className="text-sm text-muted-foreground text-center line-clamp-3 leading-relaxed px-3 group-hover:text-foreground/80 transition-colors duration-300">
          {bio}
        </p>
          ...
          <div className="flex items-center justify-center gap-2 pt-2">
            {linkedIn && (
              <Button
                variant="ghost"
                size="icon"
                className="h-11 w-11 rounded-full bg-background/50 backdrop-blur-sm border border-border/50 transition-all duration-300 hover:bg-primary/10 hover:scale-125 hover:text-primary hover:border-primary/50 hover:shadow-lg"
